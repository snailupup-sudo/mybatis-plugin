...
public class CommentPlugin extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        document.getRootElement().addElement(new TextElement("<!-- ###以上代码由软件架构生成 生成时间: " + (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(new Date()) + " ### -->\n\n\n"));
        document.getRootElement().addElement(new TextElement("<!-- 你的代码写在这里!!! -->"));
        document.getRootElement().addElement(new TextElement(""));
        return true;
    }
}